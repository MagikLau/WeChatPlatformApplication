				...
				<ul class="weui-desktop-menu weui-desktop-menu_global" id="menuBar">
					...
					<li class="weui-desktop-menu__item weui-desktop-menu_management"><span
						...
						<ul class="weui-desktop-sub-menu">
							...
							<li class="weui-desktop-sub-menu__item"><a title="学生管理" class="weui-desktop-menu__link "
							                                           data-id="10013"
							                                           href="/cgi-bin/contactmanage?t=user/index&amp;pageidx=0&amp;type=0&amp;token=630886868&amp;lang=zh_CN">
								<span class="weui-desktop-menu__link__inner">                        <span
										class="weui-desktop-menu__name">学生管理</span>          </span> </a></li>
			...
			<div id="js_mp_main_content" class="weui-desktop-layout__main">
				<div class="weui-desktop-layout__main__area">
					<div class="weui-desktop-layout__main__inner">
							...
							<div class="page_msg announcement_msg mini{if item.type === 0} with_closed{/if}">
								<div class="inner">
									<span class="msg_icon_wrp"><i
											class="icon_msg_mini {if item.type === 0}info{else}warn{/if}"></i></span>
						...
						<div class="weui-desktop-layout__main__hd"><h2>学生管理</h2>
							<#--<div class="title_tab">-->
								<#--<ul class="tab_navs title_tab">-->
									<#--<li class="tab_nav first js_top selected"><a href="javascript:;"-->
									                                             <#--id="reloadTop">已关注</a></li>-->
								...
								<div class="inner_main">
									<div class="bd">
										<#--<div class="global_mod user_group_opr">-->
                                            ...
                                            <#--<span-->
												<#--class="js_groupCommand"-->
												<#--style="display: none;">-->
                                                <#--<a href="javascript:;" class="mod_link js_tag_edit_btn">重命名</a>-->
                                                <#--<a class="mod_link js_tag_del_btn" href="javascript:;">删除</a>-->
                                            <#--</span>-->
										<#--</div>-->
										<div class="table_wrp user_list">
											<table class="table" cellspacing="0" style="display: table;">
												<thead class="thead">
												<tr>
													<#--<th class="table_cell user no_extra" colspan="2"></th>-->
												...
												<tbody class="tbody" id="userGroups">
                                                    <#list studentList as student>
                                                        <#if (student_index>280) >
                                                            <tr>
                                                                <td class="table_cell user">${student_index+1}</td>
                                                                <td class="table_cell user">
                                                                    ${student.name?substring(0,1)}*
                                                                </td>
                                                                <td class="table_cell user">${student.studentID?c}</td>
                                                                <td class="table_cell user">${student.major}</td>
                                                                <td class="table_cell user">${student.grade_class?c}</td>
                                                                <td class="table_cell user">${student.openID}</td>
                                                                <td class="table_cell user_opr">
                                                                    <#if student.openID?? && student.openID != "">
	                                                                    <a href="/students/remove?openID=${student.openID}"
											...
											<p class="no_result" style="display: none;">无结果,请重新搜索或查看
												<a href="javascript:;" id="js_reload">全部用户</a>
											</p>
										</div>
									</div>
								</div>
            ...
            <ul class="weui-desktop-menu weui-desktop-menu_global" id="menuBar">
                ...
                <li class="weui-desktop-menu__item weui-desktop-menu_management">
                    ...
                    <ul class="weui-desktop-sub-menu">
                        ...
                        <li class="weui-desktop-sub-menu__item">
                            <a title="学生管理" class="weui-desktop-menu__link " data-id="10013" href="/cgi-bin/contactmanage?t=user/index&amp;pageidx=0&amp;type=0&amp;token=630886868&amp;lang=zh_CN">
                                <span class="weui-desktop-menu__link__inner">
